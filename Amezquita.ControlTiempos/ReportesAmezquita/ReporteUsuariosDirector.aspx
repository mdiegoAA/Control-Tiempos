<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteUsuariosDirector.aspx.cs" Inherits="Amezquita.ControlTiempos.Reportes_Amezquita.ReporteUsuariosDirector" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="ReportesUsuariosProyectos.js"></script>
...
<body class="fuelux" runat="server">
    ...
    <div class="container">
       ...
       <div class="row">
        ...
        <div class="modal fade bs-example-modal-lg" id="ModalReportePersona" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title text-primary" id="ModalNombreUsuario"></h4>
      </div>
      <div class="modal-body">
           <div class="table-responsive">
                <div id="reporteUsuarios"></div>
            </div>
      </div>
