<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteGrupoTrabajo.aspx.cs" Inherits="Amezquita.ControlTiempos.Reportes_Amezquita.ReporteGrupoTrabajo" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="ReporteGrupoTrabajo.js"></script>
  ...
  <div  class="modal-dialog modal-lg">
    ...
    <div class="panel-body">                                  
        <div class="table-responsive">
            <table border="1" class='table table-striped table-bordered table-hover table-responsive' style="font-size:x-small" id='ReporteMensual'>
...
<!-- Modal -->
<div  class="modal fade bs-example-modal-lg" id="modalTiempoUsuario" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabels"><div id="titleUsuario"></div></h4>
      </div>
      <div class="modal-body">
                   <div class="container">
          <div class="row">
