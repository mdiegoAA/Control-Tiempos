<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteEjecuta.aspx.cs" Inherits="Amezquita.ControlTiempos.ReportesAmezquita.ReporteEjecuta" %>
...
<script src="bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>
    ...
    <script type="text/javascript" src="ReporteEjecutado.js"></script>
...
<body class="fuelux">
               ...
               <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <div> <button type="button" id="generalExcel" class="btn btn-default btn-xs">General Excel</button></div>
                                <br />
                                <div id="tablesRsult" runat="server" ></div>
                            </div>
                            <!-- /.table-responsive -->
    ...
    <div class="modal fade bs-example-modal-lg" id="ModalGerente" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><div id="nombreGerente"></div></h4>
      </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div>
                                ...
                                <input type="email" class="form-control" id="buscarUsuario" placeholder="Nombre del Usuario"/>
                              </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
    ...
    <div class="modal fade" id="myModalTemp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabeld">Modal title</h4>
      </div>
      <div class="modal-body">
        ...
      </div>
