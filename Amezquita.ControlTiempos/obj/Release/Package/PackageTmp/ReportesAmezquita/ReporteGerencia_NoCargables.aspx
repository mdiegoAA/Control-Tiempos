<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteGerencia_NoCargables.aspx.cs" Inherits="Amezquita.ControlTiempos.ReportesAmezquita.ReporteGerencia_NoCargables" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="ReporteGerencia_NoCargables.js"></script>
        ...
        <div class="col-md-4">          
            ...
            <div class="col-sm-6" style="height:130px">
                <div class="form-group">
                    ...
                    <div class='input-group date' id='datetimepicker9'>
                        <input type='text' id="fechass" class="form-control" />
         ...
         <div class="col-md-2"> 
              ...
              <button type="button" id="Consultar" class="btn btn-primary btn-xs form-control">Consultar</button> 
               ...
               <div class="col-md-2"> 
               <label style="color:white">Servicio</label>  
              <button type="button" id="Exportar" class="btn btn-primary btn-xs form-control">Exportar Excel</button> 
