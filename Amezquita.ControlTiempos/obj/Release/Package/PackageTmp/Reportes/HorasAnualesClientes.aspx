<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reportes/Layout.Master" CodeBehind="HorasAnualesClientes.aspx.cs" Inherits="Amezquita.ControlTiempos.Reportes.HorasAnualesClientes" %>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <asp:ObjectDataSource ID="DirectoresDataSource" runat="server" SelectMethod="GetData" TypeName="Amezquita.ControlTiempos.Reportes.DataSets.DirectoresDataSetTableAdapters.DirectoresTableAdapter" OldValuesParameterFormatString="original_{0}"></asp:ObjectDataSource>
                        </div>
                    </div>
                    <div class="control-group">
