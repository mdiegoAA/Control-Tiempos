// ----------------------------------------------------------------------------------------------
// <copyright file="ModificarRegistrarTiempos.cs" company="SCI Software">
...
{
    public class ModificarRegistrarTiempos
    {
        ...
        public class Handler : AsyncRequestHandler<Command>
        {
            ...
            protected override async Task HandleCore(Command message)
            {
                ...
                var existe = await _unidadDeTrabajo.CarguesHoras
                                                   .Where(ch => ch.RegistradaPor.Id == message.UsuarioId && ch.Id != message.Id)
                ...
                var cargueHorasEntity = await _unidadDeTrabajo.CarguesHoras.Include(c => c.Proyecto).FirstOrDefaultAsync(p => p.Id == message.Id);
                cargueHorasEntity.Proyecto = cargueHoras.Proyecto;
                cargueHorasEntity.Servicio = cargueHoras.Servicio;
                cargueHorasEntity.Actividad = cargueHoras.Actividad;
                cargueHorasEntity.FechaInicio = cargueHoras.FechaInicio;
                cargueHorasEntity.FechaFin = cargueHoras.FechaFin;
                cargueHorasEntity.Observacion = cargueHoras.Observacion;
